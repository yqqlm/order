...
if ($addnew=="1" )
{
	...
	echo "id=".$id;
	$table->setValsFromPost("caigoudan");
	$msg=$table->setRecord("caigoudan",null);
	if($msg==""){
		echo "<script>javascript:alert('修改成功');location.href='caigoudan_updt.php?id=".$id."';</script>";
	}else{
		echo $msg;
		echo  "<script>javascript:alert('".$msg."');location.href='caigoudan_updt.php?id=".$id."';</script>";
	}
...
<title>修改采购单</title><script language="javascript" src="js/Calendar.js"></script><link rel="stylesheet" href="css.css" type="text/css">
</head>
<?php echo getCommonScript();?>
<body>
<p>修改采购单<?php echo $ndate; ?></p>
...
<?php
echo $table->getDetail("caigoudan",2,null);
?>
</form>
<p>&nbsp;</p>
</body>
